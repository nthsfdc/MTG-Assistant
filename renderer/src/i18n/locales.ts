...
const ja: Locale = {
  ...
  post: {
    ...
    tabs: { overview: '概要', transcript: '文字起こし', todos: 'Todo' },
...
const en: Locale = {
  ...
  post: {
    ...
    tabs: { overview: 'Overview', transcript: 'Transcript', todos: 'Todos' },
...
const vi: Locale = {
  ...
  post: {
    ...
    tabs: { overview: 'Tổng quan', transcript: 'Bản ghi', todos: 'Việc cần làm' },
